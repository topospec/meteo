<html><head>
    <title>Estacion Meteorologica - Rivadavia, Mendoza</title>
    <meta charset="utf-8">
    ...
    <div class="section section-primary">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="text-center">Estación meteorológica
              <br>Visualizacion de datos en tiempo real</h2>
          </div>
        </div>
      </div>
    </div>
    <div class="section">
      <div class="container">
	  <IMG SRC="/gifclima.gif">

        <h4 class="text-center">
            <?php 
			
			$conexion=mysqli_connect( "mysql.hostinger.com.ar",
			...
			echo "<b>Fecha y hora (UTC): </b>".$extraido[ 'fecha']. "<br>"; 
			...
			echo"<b>Sensacion termica: </b>".$extraido[ 'stermica']. " grados Celsius"; 
			} 
    ...
    <footer class="section section-primary">
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <h1></h1>
            <p>Matías Caparros - 2016 - UTN FRM
              <br>Ubicación de la estación meteorológica: Rivadavia, Mendoza, Argentina
              <br>Latitud: -33.162774 | Longitud: -68.44462
              <br>caparrosmatias96@gmail.com</p>
          </div>
        </div>
      </div>
    </footer>
